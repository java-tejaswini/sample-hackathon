...
In this final challenge, you have been tasked with creating a custom agent, skill or both !!!

## Create a novel Copilot Skill or Agent that:
...
* Provides clear, traceable, and actionable outputs for both technical and business stakeholders
...
* Preserves and validates business intent while improving implementation quality
* Can be realistically adopted within your team’s delivery lifecycle
